...
export class SwaggerService {
    ...
    private data: ISwagger | undefined;
    private modelsMap: { [key: string]: ISwaggerBuildDefinitionModel } = {};
    private globalResponses: { [key: string]: IApiOperationArgsBaseResponse } | undefined;
    ...
    public setDefinitions(models: { [key: string]: ISwaggerBuildDefinitionModel }): void {
        ...
        for (const modelIndex in models) {
            ...
            for (const propertyIndex in model.properties) {
                const property: ISwaggerBuildDefinitionModelProperty = model.properties[propertyIndex];
    ...
    public setGlobalResponses(globalResponses: { [key: string]: IApiOperationArgsBaseResponse }): void {
        ...
        if (args.parameters) {
            ...
            if (args.parameters.header) {
                operation.parameters = _.concat(
                    operation.parameters,
                    this.buildParameters(SwaggerDefinitionConstant.Parameter.In.HEADER, args.parameters.header),
                );
            }
            ...
            if (args.parameters.formData) {
                operation.parameters = _.concat(
                    operation.parameters,
                    this.buildParameters(SwaggerDefinitionConstant.Parameter.In.FORM_DATA, args.parameters.formData),
                );
            }
        }
    ...
    private buildOperationResponses(responses: { [key: string]: IApiOperationArgsBaseResponse }): {
    ...
    private buildBodyOperationParameter(
        ...
        swaggerOperationParameter.description = bodyOperationArgsBaseParameter.description;
        swaggerOperationParameter.required = bodyOperationArgsBaseParameter.required;
        swaggerOperationParameter.format = bodyOperationArgsBaseParameter.format;
        swaggerOperationParameter.deprecated = bodyOperationArgsBaseParameter.deprecated;
        swaggerOperationParameter.allowEmptyValue = bodyOperationArgsBaseParameter.allowEmptyValue;
        ...
        if (bodyOperationArgsBaseParameter.properties) {
            ...
            for (const propetyIndex in bodyOperationArgsBaseParameter.properties) {
                const propertyBodyOperationArgsBaseParameter = bodyOperationArgsBaseParameter.properties[propetyIndex];
                const propertySchemaOperation = {} as ISwaggerPropertySchemaOperation;
                propertySchemaOperation.type = propertyBodyOperationArgsBaseParameter.type;
    ...
    private buildParameters(
        ...
        for (const parameterIndex in parameters) {
            const parameter: IApiOperationArgsBaseParameter = parameters[parameterIndex];
